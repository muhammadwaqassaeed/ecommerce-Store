...
mongoose.connect("mongodb+srv://yasir:baig@cluster0.rmza1ek.mongodb.net/e-shop");
//API Creation
app.get("/", (req, res) => {
...
// creating endpoints for popular in women
app.get('/popularinwomen', async(req, res)=>{
    let products = await Product.find({category:"women"});
    let popular_in_women = products.slice(0, 4);
    console.log("popluar in women fetched");
    ...
    if(!token){
        ...
        try{
            ...
            next()
                ...
                res.status(401).send({errors: "please autheticate the valid token"})
        }
    }
}
